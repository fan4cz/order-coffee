...
function getBeverageData(beverageFieldset) {
  const beverageNumber =
    beverageFieldset.querySelector(".beverage-count").textContent;
  ...
  const selectedMilk = beverageFieldset.querySelector(
  ...
  const checkboxes = beverageFieldset.querySelectorAll(
